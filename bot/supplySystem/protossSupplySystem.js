...
const calculateSupplyGap = (gameLoop, supply, bases) => {
...
const protossSupplySystem = createSystem({
  name: 'SupplySystem',
  type: 'agent',
  ...
  async onStep({agent, data, resources}, gameLoop) {
    ...
    const conditions = [
      ...
      console.log('map.getExpansions(): ', map.getExpansions());
...
module.exports = {protossSupplySystem};